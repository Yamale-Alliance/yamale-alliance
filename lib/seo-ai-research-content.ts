/** Shared copy for AI research SEO pages — server-rendered for crawlers. */
...
export const AI_RESEARCH_MAIN_SEO = {
...
export const SEO_LANDING_PAGES: SeoLandingPageContent[] = [
  {
    ...
    features: [...AI_RESEARCH_MAIN_SEO.features],
    faqs: [...AI_RESEARCH_MAIN_SEO.faqs],
    relatedLinks: [
...
export function seoLandingByPath(path: string): SeoLandingPageContent | undefined {

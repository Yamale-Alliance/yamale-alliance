...
export function AuthShell({ title, subtitle, children, footer }: AuthShellProps) {
  return (
    <div className="mx-auto flex w-full max-w-md flex-col px-4 py-10 sm:py-14">
      <div className="rounded-xl border border-border bg-card p-6 shadow-[0_4px_24px_rgba(13,27,42,0.08)] sm:p-8">
        <Link
          href="/"
        ...
        <div className="yamale-auth-clerk mt-6">{children}</div>
      </div>

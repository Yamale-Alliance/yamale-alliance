...
export default function AdminAiBugsPage() {
  ...
  return (
    <div className="p-4 sm:p-6">
      <h1 className="heading text-2xl font-bold">AI feedback triage</h1>
      <p className="mt-1 text-sm text-muted-foreground">
        Negative AI feedback with full conversation snapshots for investigation.
      </p>

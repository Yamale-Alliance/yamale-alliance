...
/**
 * After Stripe redirect: confirm marketplace payment from session_id and record purchase.
...
export async function POST(request: NextRequest) {
  try {
    ...
    const marketplaceItemId = session.metadata?.marketplace_item_id as string | undefined;

 ...
 *
 * Options:
 *   --country "Ghana"           (default: Ghana) — must be one of: Ghana, Kenya, Tunisia, Ethiopia, Madagascar, Rwanda, Seychelles
...
if (!pdfPath) {
  console.error("Usage: node --env-file=.env scripts/import-pdf-law.mjs \"/path/to/file.pdf\" [--country Ghana|Kenya|Tunisia|Ethiopia|Madagascar|Rwanda|Seychelles] [--title \"...\"] [--category \"...\"] [--year 2019] [--source-url \"...\"] [--status \"In force\"] [--update]");
  process.exit(1);
}
...
const VALID_COUNTRIES = ["Ghana", "Kenya", "Tunisia", "Ethiopia", "Madagascar", "Rwanda", "Seychelles"];
